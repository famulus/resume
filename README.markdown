...
Responsible for development and support of London 2012 Olympics syndication. Implemented internationalization, localization, and admin interfaces with the Interactive News team. Handled technical sales. Setup production infrastructure using Amazon Web Services. Developed Reuters feed ingest with auto publishing. 
